...
-- depends_on: {{ source('telegram', '_airbyte_raw_messages') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['edited_at'], ['edited_at']) }} as edited_at,
...
from {{ source('telegram', '_airbyte_raw_messages') }} as table_alias
-- messages
where 1 = 1
